...
2. Если видим `form#kcaptchaForm`, забираем `/captcha.php`
3. Отправляем изображение в RuCaptcha (`rucaptcha.com`)
4. Polling до результата
5. Подставляем ответ в `input[name="captcha-response"]`
6. Сабмитим форму
